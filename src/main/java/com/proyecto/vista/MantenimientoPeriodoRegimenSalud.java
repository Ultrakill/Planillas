 ...
 * @author Documentos
 */
public class MantenimientoPeriodoRegimenSalud extends javax.swing.JInternalFrame {

    /**
     * Creates new form MantenimientoPeriodoTipoTrabajador
     */
    private static MantenimientoPeriodoRegimenSalud instancia;

    public MantenimientoPeriodoRegimenSalud() {
        initComponents();
    ...
    public static MantenimientoPeriodoRegimenSalud getInstancia() {
        if (instancia == null) {
            instancia = new MantenimientoPeriodoRegimenSalud();
        }
        return instancia;
    }
    ...
    private void initComponents() {
        ...
        tblPeriodoSalud = new javax.swing.JTable();
        ...
        tblPeriodoSalud.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane3.setViewportView(tblPeriodoSalud);
        ...
        cmbRegimenSalud.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
            ...
            .addGroup(panelDatosLayout.createSequentialGroup()
                ...
                .addGroup(panelDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelDatosLayout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(cmbRegimenSalud, javax.swing.GroupLayout.PREFERRED_SIZE, 287, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(panelDatosLayout.createSequentialGroup()
                        .addGroup(panelDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (accion == 1) {
            ...
            if (JOptionPane.showConfirmDialog(null, "¿Desea " + palabra + " el Periodo?", "Mensaje del Sistema", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                pRegimenSaludControlador.getSeleccionado().setFechaInicio(jdateInicial.getDate());
                pRegimenSaludControlador.getSeleccionado().setFechaFin(jdateFinal.getDate());
                pRegimenSaludControlador.getSeleccionado().setVigente(chckVigente.isSelected());
                pRegimenSaludControlador.getSeleccionado().setRegimenAseguramiento((RegimenAseguramiento) cmbRegimenSalud.getSelectedItem());
                pRegimenSaludControlador.getSeleccionado().setNombre(((RegimenAseguramiento) cmbRegimenSalud.getSelectedItem()).getNombre());

                pRegimenSaludControlador.accion(accion);
                lista.add(pRegimenSaludControlador.getSeleccionado());
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        pRegimenSaludControlador.prepararCrear();
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        ...
        cargarComboRegimenSalud();
        int fila = this.tblPeriodoSalud.getSelectedRow();
        if (fila != -1) {
            FormularioUtil.activarComponente(panelDatos, true);
            FormularioUtil.activarComponente(panelOpciones, false);
            FormularioUtil.activarComponente(panelGuardar, true);
            ...
            accion = AbstractControlador.MODIFICAR;
            pRegimenSaludControlador.setSeleccionado(lista.get(fila));
            PeriodoRegimenSalud rSalud = pRegimenSaludControlador.getSeleccionado();

            jdateInicial.setDate(rSalud.getFechaInicio());
            jdateFinal.setDate(rSalud.getFechaFin());
            chckVigente.setSelected(rSalud.isVigente());

            cmbRegimenSalud.setSelectedItem(rSalud.getRegimenAseguramiento());
    ...
    private void chckVigenteBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chckVigenteBActionPerformed
        ...
        if (chckVigenteB.isSelected()) {
            lista.clear();
            lista.addAll(this.pRegimenSaludControlador.buscarXContratoVigente(true));
        } else {
            lista.clear();
            lista.addAll(this.pRegimenSaludControlador.buscarXContratoVigente(false));
        }
    }//GEN-LAST:event_chckVigenteBActionPerformed

    private final PeriodoRegimenSaludControlador pRegimenSaludControlador = new PeriodoRegimenSaludControlador();
    private List<PeriodoRegimenSalud> lista;
    private int accion;
    ...
    private javax.swing.JTable tblPeriodoSalud;
    // End of variables declaration//GEN-END:variables

    private void listar() {
        lista = this.pRegimenSaludControlador.buscarTodos();
        lista = ObservableCollections.observableList(lista);

        JTableBinding binding = SwingBindings.createJTableBinding(AutoBinding.UpdateStrategy.READ, lista, tblPeriodoSalud);
        ...
        BeanProperty bTipoTrabajador = BeanProperty.create("regimenAseguramiento");
        ...
        binding.addColumnBinding(bTipoTrabajador).setColumnName("REGIMEN_ASEGURAMIENTO").setEditable(false);
